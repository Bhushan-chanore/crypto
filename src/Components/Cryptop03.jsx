...
function Cryptop03() {
  ...
  return (
    <div>
      <section className="absolute sm:left-[7.2%] sm:w-[1340px] flex flex-row items-start justify-start sm:gap-[1.188rem] max-w-full text-center sm:text-[3.75rem] text-[3.4rem] text-white font-montserrat overflow-hidden">
